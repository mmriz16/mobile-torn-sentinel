        ...
        <SafeAreaView className="flex-1 bg-tactical-950">
            ...
            <ScrollView className="flex-1" contentContainerStyle={{ padding: ms(16), gap: vs(16) }}>
                ...
                <View style={{ gap: vs(10) }}>
                    ...
                    <View className="flex-row" style={{ gap: vs(10) }}>
                        <TouchableOpacity className="flex-1" activeOpacity={0.7} onPress={() => router.push('/(quick-actions)/bank/torn-bank' as any)}>
                        ...
                        <TouchableOpacity className="flex-1" activeOpacity={0.7} onPress={() => router.push('/(quick-actions)/bank/offshore-bank' as any)}>
                            <Card className="items-center" style={{ padding: ms(16) }}>
                                <Text className="text-white uppercase" style={{ fontFamily: 'Inter_600SemiBold', fontSize: ms(8) }}>Offshore Bank</Text>
                            </Card>
                        </TouchableOpacity>
                        <TouchableOpacity className="flex-1" activeOpacity={0.7} onPress={() => router.push('/(quick-actions)/bank/company-stocks' as any)}>
                            <Card className="items-center" style={{ padding: ms(16) }}>
