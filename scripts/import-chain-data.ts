// scripts/import-chain-data.ts
// Script to convert data.json to SQL INSERT statements
// Run with: npx ts-node scripts/import-chain-data.ts
...
async function main() {
    ...
    const data = JSON.parse(rawData) as Record<string, ChainTarget[]>;

    // Flatten all lists into one array
    const allTargets: ChainTarget[] = [];
    ...
    // Generate SQL
    let sql = `-- Generated by import-chain-data.ts
