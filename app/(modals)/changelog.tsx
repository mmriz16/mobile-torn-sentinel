                ...
                <View className="flex-1" style={{ padding: ms(16) }}>
                    ...
                    {loading ? (
                        ...
                        >
                            ...
                            {/* VERSION 1.1.15 - Newest */}
                            <Card className="border border-tactical-800" style={{ borderRadius: ms(8) }}>
                                <View className="flex-row justify-between items-center bg-tactical-950 border-b border-tactical-800" style={{ padding: ms(16) }}>
                                    <Text className="text-white/50 uppercase" style={{ fontFamily: 'Inter_800ExtraBold', fontSize: ms(14) }}>Version 1.1.15</Text>
                                    <Text className="text-white/70 uppercase" style={{ fontFamily: 'JetBrainsMono_400Regular', fontSize: ms(10) }}>Feb, 3 2026</Text>
                                </View>
                                <View className="bg-tactical-950" style={{ gap: ms(6), padding: ms(16) }}>
                                    <View className="flex-row items-center" style={{ gap: ms(4) }}>
                            ...
                            {/* VERSION 1.1.16 - Newest */}
                            <Card className="border border-tactical-800" style={{ borderRadius: ms(8) }}>
                                <View className="flex-row justify-between items-center bg-tactical-950 border-b border-tactical-800" style={{ padding: ms(16) }}>
                                    <Text className="text-white/50 uppercase" style={{ fontFamily: 'Inter_800ExtraBold', fontSize: ms(14) }}>Version 1.1.16</Text>
                                    <Text className="text-white/70 uppercase" style={{ fontFamily: 'JetBrainsMono_400Regular', fontSize: ms(10) }}>Feb, 3 2026</Text>
                                </View>
                                <View className="bg-tactical-950" style={{ gap: ms(6), padding: ms(16) }}>
                                    <View className="flex-row items-center" style={{ gap: ms(4) }}>
                                    ...
                                    <View style={{ paddingLeft: ms(3) }}>
                                        <View className="border-l border-tactical-800" style={{ paddingVertical: ms(4), paddingLeft: ms(8) }}>
                                            <View className="bg-tactical-900 border border-tactical-800" style={{ padding: ms(10), gap: ms(4) }}>
                                                <Text className="text-white/70" style={{ fontFamily: 'JetBrainsMono_400Regular', fontSize: ms(10) }}>- Fixed notification color to #FCF3EC and verified asset optimization</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
                            ...
                            {/* VERSION 1.1.17 - Newest */}
                            <Card className="border border-tactical-800" style={{ borderRadius: ms(8) }}>
                                <View className="flex-row justify-between items-center bg-tactical-950 border-b border-tactical-800" style={{ padding: ms(16) }}>
                                    <Text className="text-white/50 uppercase" style={{ fontFamily: 'Inter_800ExtraBold', fontSize: ms(14) }}>Version 1.1.17</Text>
                                    <Text className="text-white/70 uppercase" style={{ fontFamily: 'JetBrainsMono_400Regular', fontSize: ms(10) }}>Feb, 3 2026</Text>
                                </View>
                                <View className="bg-tactical-950" style={{ gap: ms(6), padding: ms(16) }}>
                                    <View className="flex-row items-center" style={{ gap: ms(4) }}>
                                    ...
                                    <View style={{ paddingLeft: ms(3) }}>
                                        <View className="border-l border-tactical-800" style={{ paddingVertical: ms(4), paddingLeft: ms(8) }}>
                                            <View className="bg-tactical-900 border border-tactical-800" style={{ padding: ms(10), gap: ms(4) }}>
                                                <Text className="text-white/70" style={{ fontFamily: 'JetBrainsMono_400Regular', fontSize: ms(10) }}>- Refactored to Notifee for consistent custom notification icons</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
                            ...
                            {/* VERSION 1.1.18 - Newest */}
                            <Card className="border border-tactical-800" style={{ borderRadius: ms(8) }}>
                                <View className="flex-row justify-between items-center bg-tactical-950 border-b border-tactical-800" style={{ padding: ms(16) }}>
                                    <Text className="text-white/50 uppercase" style={{ fontFamily: 'Inter_800ExtraBold', fontSize: ms(14) }}>Version 1.1.18</Text>
                                    <Text className="text-white/70 uppercase" style={{ fontFamily: 'JetBrainsMono_400Regular', fontSize: ms(10) }}>Feb, 3 2026</Text>
                                </View>
                                <View className="bg-tactical-950" style={{ gap: ms(6), padding: ms(16) }}>
                                    <View className="flex-row items-center" style={{ gap: ms(4) }}>
                                    ...
                                    <View style={{ paddingLeft: ms(3) }}>
                                        <View className="border-l border-tactical-800" style={{ paddingVertical: ms(4), paddingLeft: ms(8) }}>
                                            <View className="bg-tactical-900 border border-tactical-800" style={{ padding: ms(10), gap: ms(4) }}>
                                                <Text className="text-white/70" style={{ fontFamily: 'JetBrainsMono_400Regular', fontSize: ms(10) }}>- Final Fixes: Notifee, Happy Full Logic, Optimized Assets</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
