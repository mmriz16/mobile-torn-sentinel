...
import { ActivityIndicator, Image, PanResponder, Text, TextInput, TouchableOpacity, View } from "react-native";
        ...
        <SafeAreaView className="flex-1 bg-tactical-950">
            ...
            <View className="flex-1" style={{ padding: ms(16), gap: vs(16) }}>
                ...
                <Card style={{ padding: ms(16), gap: vs(24), overflow: 'hidden' }}>
                    ...
                    <Text className="text-accent-yellow text-center" style={{ fontFamily: 'JetBrainsMono_800ExtraBold', fontSize: ms(34) }}>{formatCurrency(tornBank)}</Text>
                    <View className="flex-row justify-between">
                        <View style={{ gap: vs(2) }}>
