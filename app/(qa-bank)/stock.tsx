...
import { ArrowLeft, MoreHorizontal, TrendingDown, TrendingUp } from "lucide-react-native";
    ...
    return (
        <SafeAreaView className="flex-1 bg-tactical-950">
            ...
            <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: vs(32) }}>
                {/* Header */}
                <View className="flex-row items-center justify-between" style={{ padding: ms(16) }}>
                    <TouchableOpacity onPress={() => router.back()}>
                        <ArrowLeft size={ms(24)} color="white" />
                    </TouchableOpacity>
                    <Text className="text-white uppercase" style={{ fontFamily: 'Inter_700Bold', fontSize: ms(14) }}>
                        {stock?.acronym || 'TCHS'}
                    </Text>
                    <TouchableOpacity>
                        <MoreHorizontal size={ms(24)} color="white" />
                    </TouchableOpacity>
                </View>
